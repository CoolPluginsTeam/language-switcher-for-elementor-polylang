...
class cool_plugins_lsep_polylang_addons {
	...
	public function displayPluginAdminDashboard() {
		...
		echo '<a href="' . esc_url( 'https://wordpress.org/support/plugin/language-switcher-for-elementor-polylang/#new-topic-0' ) . '" class="button button-secondary lsep-header-btn lsep-header-btn-support" target="_blank" rel="noopener noreferrer" title="' . esc_attr__( 'Get Support', 'language-switcher-for-elementor-polylang' ) . '"><span class="dashicons dashicons-editor-help lsep-header-btn-question-icon" aria-hidden="true"></span><span class="lsep-header-btn-label">' . esc_html__( 'Get Support', 'language-switcher-for-elementor-polylang' ) . '</span></a>';
		echo '<a href="' . esc_url( 'https://docs.coolplugins.net/doc/language-switcher-for-elementor-polylang/?utm_source=lsep_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_header' ) . '" class="button button-secondary lsep-header-btn" target="_blank" rel="noopener noreferrer" title="' . esc_attr__( 'Documentation', 'language-switcher-for-elementor-polylang' ) . '"><span class="dashicons dashicons-book" aria-hidden="true"></span><span class="lsep-header-btn-label">' . esc_html__( 'Documentation', 'language-switcher-for-elementor-polylang' ) . '</span></a>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
